  ...
  projects: [
    {
      ...
      logos: [{ src: '/ragnosis.png', alt: 'RAGnosis' }],
      description:
  ...
  expertise: [
    ...
    },
    {
      ...
      skills: [
        ...
        'Open Models (Qwen, Llama 3, Gemma)',
        'Cloud APIs (OpenAI, Claude, OpenRouter)',
